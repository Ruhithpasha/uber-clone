...
createRoot(document.getElementById('root')).render( //creating the root element of the application this is the main entry point of the application and this is the root element with id root
  <StrictMode> 
